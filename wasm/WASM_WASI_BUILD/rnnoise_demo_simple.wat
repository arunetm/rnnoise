(module
  ...
  (type (;24;) (func (param i32 i32 i32) (result f32)))
  (type (;25;) (func (param i32 i32 i32 i32 i32 i32 f32) (result f32)))
  (type (;26;) (func (param f32) (result f32)))
  (type (;27;) (func (param f64 i32) (result f64)))
  (type (;28;) (func (param f64 f64) (result f64)))
  (type (;29;) (func (param f64 f64 i32) (result f64)))
  (import "env" "__sys_open" (func $__syscall5 (type 1)))
  (import "env" "__sys_fcntl64" (func $__syscall221 (type 1)))
  (import "env" "__sys_ioctl" (func $__syscall54 (type 1)))
  ...
  (import "env" "__handle_stack_overflow" (func $__handle_stack_overflow (type 10)))
  ...
  (import "env" "table" (table (;0;) 7 funcref))
  (func $emscripten_get_sbrk_ptr (type 5) (result i32)
    i32.const 98576)
  ...
  (func $stb_radix_3_dit (type 3) (param i32 i32 i32)
  ...
  (func $stb_radix_4_dit (type 3) (param i32 i32 i32)
  ...
  (func $stb_radix_5_dit (type 3) (param i32 i32 i32)
  ...
  (func $stb_radix_6_dit (type 3) (param i32 i32 i32)
  ...
  (func $stb_radix_7_dit (type 3) (param i32 i32 i32)
  ...
  (func $stb_radix_8_dit (type 3) (param i32 i32 i32)
  ...
  (func $rnnoise_create (type 5) (result i32)
  ...
  (func $rnnoise_process_frame (type 24) (param i32 i32 i32) (result f32)
    ...
    local.get 19)
  (func $forward_transform (type 13) (param i32 i32)
  ...
  (func $_celt_lpc (type 3) (param i32 i32 i32)
  ...
  (func $_celt_autocorr (type 17) (param i32 i32 i32 i32 i32 i32) (result i32)
    ...
    i32.const 0)
  (func $pitch_downsample (type 11) (param i32 i32 i32 i32)
  ...
  (func $remove_doubling (type 25) (param i32 i32 i32 i32 i32 i32 f32) (result f32)
    ...
    local.get 26)
  (func $compute_dense (type 3) (param i32 i32 i32)
  ...
  (func $compute_rnn (type 11) (param i32 i32 i32 i32)
  ...
  (func $isdigit (type 0) (param i32) (result i32)
    ...
    i32.const 10
    i32.lt_u)
  (func $pthread_self (type 5) (result i32)
    i32.const 92556)
  (func $wcrtomb (type 1) (param i32 i32 i32) (result i32)
    ...
    i32.store8
    i32.const 1)
  (func $__pthread_self (type 5) (result i32)
    call $pthread_self)
  ...
  (func $fmt_o (type 14) (param i64 i32) (result i32)
    ...
    local.get 1)
  (func $fmt_x (type 21) (param i64 i32 i32) (result i32)
    block  ;; label = @1
      local.get 0
      i64.eqz
      br_if 0 (;@1;)
  ...
  (func $__wasi_syscall_ret (type 0) (param i32) (result i32)
    ...
    i32.store
    i32.const -1)
  (func $__cos (type 28) (param f64 f64) (result f64)
    (local f64 f64 f64)
    f64.const 0x1p+0 (;=1;)
    local.get 0
    local.get 0
  ...
  (func $__rem_pio2 (type 22) (param f64 i32) (result i32)
    ...
    local.get 4)
  (func $__sin (type 29) (param f64 f64 i32) (result f64)
    (local f64 f64 f64)
    local.get 0
    local.get 0
    f64.mul
      ...
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
                    ...
                    block  ;; label = @9
                      block  ;; label = @10
                        block  ;; label = @11
                          block  ;; label = @12
                            ...
                            block  ;; label = @13
                              ...
                              block  ;; label = @14
                                block  ;; label = @15
                                  ...
                                  i32.rotl
                                  i32.and
                                  i32.store offset=97040
                                  br 1 (;@14;)
                                end
                                i32.const 0
                                i32.load offset=97056
                                local.get 6
                                i32.gt_u
                                drop
                                local.get 6
                            ...
                            block  ;; label = @13
                              ...
                              i32.const 0
                              local.get 5
                              i32.store offset=97060
                              i32.const 0
                              local.get 6
                              i32.store offset=97048
                              br 12 (;@1;)
                            end
                            i32.const 0
                            i32.load offset=97044
                            local.tee 9
                            i32.eqz
                            br_if 1 (;@11;)
                            local.get 9
                        ...
                        block  ;; label = @11
                          ...
                          i32.sub
                          local.tee 4
                          i32.store offset=97052
                          i32.const 0
                          i32.const 0
                          i32.load offset=97064
                          local.tee 0
                          local.get 3
                          i32.add
                          local.tee 6
                          i32.store offset=97064
                          local.get 6
                          local.get 4
                          i32.const 1
                          i32.or
                        ...
                        block  ;; label = @11
                          block  ;; label = @12
                            i32.const 0
                            i32.load offset=97512
                            i32.eqz
                            br_if 0 (;@12;)
                            i32.const 0
                            i32.load offset=97520
                            local.set 4
                            br 1 (;@11;)
                          end
                          i32.const 0
                          i64.const -1
                          i64.store offset=97524 align=4
                          i32.const 0
                          i64.const 17592186048512
                          i64.store offset=97516 align=4
                          i32.const 0
                          local.get 1
                          i32.const 12
                          i32.add
                          ...
                          i32.xor
                          i32.store offset=97512
                          i32.const 0
                          i32.const 0
                          i32.store offset=97532
                          i32.const 0
                          i32.const 0
                          i32.store offset=97484
                          i32.const 4096
                          local.set 4
                        end
                        i32.const 0
                        ...
                        block  ;; label = @11
                          i32.const 0
                          i32.load offset=97480
                          local.tee 4
                          i32.eqz
                          br_if 0 (;@11;)
                          i32.const 0
                          i32.load offset=97472
                          local.tee 6
                          local.get 8
                          i32.add
                          local.tee 9
            ...
            i32.add
            local.tee 0
            i32.store offset=97472
            block  ;; label = @5
              local.get 0
              i32.const 0
              i32.load offset=97476
              i32.le_u
              br_if 0 (;@5;)
              i32.const 0
              local.get 0
              i32.store offset=97476
            end
            block  ;; label = @5
              block  ;; label = @6
                block  ;; label = @7
                  ...
                  block  ;; label = @8
                    ...
                    i32.const 0
                    local.get 5
                    i32.store offset=97056
                  end
                  i32.const 0
                  local.set 0
                  i32.const 0
                  local.get 2
                  i32.store offset=97492
                  i32.const 0
                  local.get 5
                  i32.store offset=97488
                  i32.const 0
                  i32.const -1
                  i32.store offset=97072
                  i32.const 0
                  i32.const 0
                  i32.load offset=97512
                  i32.store offset=97076
                  i32.const 0
                  i32.const 0
                  i32.store offset=97500
                  loop  ;; label = @8
                    local.get 0
                    i32.const 3
                    i32.shl
                  ...
                  i32.const 0
                  i32.const 0
                  i32.load offset=97528
                  i32.store offset=97068
                  br 2 (;@5;)
                end
                local.get 0
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=97496 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=97488 align=4
                    i64.store offset=8 align=4
                    i32.const 0
                    local.get 8
                    i32.const 8
                    i32.add
                    i32.store offset=97496
                    i32.const 0
                    local.get 2
                    i32.store offset=97492
                    i32.const 0
  ...
  (func $dlcalloc (type 4) (param i32 i32) (result i32)
    (local i32 i64)
    block  ;; label = @1
      block  ;; label = @2
        local.get 0
  ...
  (func $sbrk (type 0) (param i32) (result i32)
    ...
    i32.store
    i32.const -1)
  (func $log10f (type 26) (param f32) (result f32)
  ...
  (func $strlen (type 0) (param i32) (result i32)
    ...
    local.get 0
    i32.sub)
  (func $__set_stack_limit (type 2) (param i32)
    local.get 0
    global.set 10)
  ...
  (func $__growWasmMemory (type 0) (param i32) (result i32)
    local.get 0
    memory.grow)
  (func $dynCall_jiji (type 23) (param i32 i32 i64 i32) (result i64)
    local.get 1
    local.get 2
    local.get 3
    local.get 0
    call_indirect (type 9))
  (func $dynCall_iiii (type 7) (param i32 i32 i32 i32) (result i32)
    local.get 1
    local.get 2
    local.get 3
    local.get 0
  ...
  (func $legalstub$dynCall_jiji (type 8) (param i32 i32 i32 i32 i32) (result i32)
    ...
    local.get 5
    i32.wrap_i64)
  (func $legalfunc$__wasi_fd_seek (type 19) (param i32 i64 i32 i32) (result i32)
    local.get 0
    local.get 1
    i32.wrap_i64
    local.get 1
  ...
  (global (;0;) (mut i32) (i32.const 5341616))
  (global (;1;) i32 (i32.const 0))
  (global (;2;) i32 (i32.const 89552))
  (global (;3;) i32 (i32.const 92424))
  (global (;4;) i32 (i32.const 92444))
  (global (;5;) i32 (i32.const 92536))
  (global (;6;) i32 (i32.const 92468))
  (global (;7;) i32 (i32.const 92492))
  (global (;8;) i32 (i32.const 92516))
  (global (;9;) i32 (i32.const 98568))
