...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 97232,
    DYNAMIC_BASE = 5340112,
    DYNAMICTOP_PTR = 97072;
...
// {{PRE_LIBRARY}}
  ...
  Module["SYSCALLS"] = SYSCALLS;function _fd_close(fd) {
      return 0;
    }
  ...
  Module["flush_NO_FILESYSTEM"] = flush_NO_FILESYSTEM;function _fd_write(fd, iov, iovcnt, pnum) {
...
var asmGlobalArg = {};
var asmLibraryArg = { "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "fd_close": _fd_close, "fd_seek": _fd_seek, "fd_write": _fd_write, "memory": wasmMemory, "setTempRet0": _setTempRet0, "table": wasmTable };
var asm = createWasm();
Module["asm"] = asm;
/** @type {function(...*):?} */
...
var _Resample_f32 = Module["_Resample_f32"] = function() {
  return (_Resample_f32 = Module["_Resample_f32"] = Module["asm"]["Resample_f32"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _denoise_proc_mono = Module["_denoise_proc_mono"] = function() {
  return (_denoise_proc_mono = Module["_denoise_proc_mono"] = Module["asm"]["denoise_proc_mono"]).apply(null, arguments);
};
